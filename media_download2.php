...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $urls = [
        ...
        filter_input(INPUT_POST, 'media_url_2', FILTER_VALIDATE_URL),
        filter_input(INPUT_POST, 'media_url_3', FILTER_VALIDATE_URL)
    ];
...
<body>
    ...
    <form method="post" action="">
        ...
        <label for="media_url_2">Media File URL 2 (MP4 or MP3 only):</label>
        <input type="text" id="media_url_2" name="media_url_2" required><br><br>
        <label for="media_url_3">Media File URL 3 (MP4 or MP3 only):</label>
        <input type="text" id="media_url_3" name="media_url_3" required><br><br>
